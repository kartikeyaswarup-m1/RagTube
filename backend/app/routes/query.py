        ...
        try:
            ...
            try:
                ...
                if loaded:
                    ...
                    # Querying only uses content that was successfully ingested.
                    # It must not trigger another YouTube request: cloud access can
                    # be blocked and manual transcripts have no YouTube fallback.
                    raise re
